package ie.wit.work_iot_mobile.ui.auth
...
import ie.wit.work_iot_mobile.databinding.LoginBinding
import ie.wit.work_iot_mobile.ui.home.Home
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("WorkIOT Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
